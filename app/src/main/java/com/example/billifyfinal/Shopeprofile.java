...
public class Shopeprofile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopeprofile);
            ...
            public void onClick(View v) {
                ...
                Log.d("tag", "onClick: " + nametext + emailText + phoneText +addText);
                    if (nametext.equals("") && emailText.equals("") && phoneText.equals("") && addText.equals("")) {
                        Toast.makeText(Shopeprofile.this, "Please, fill details", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        usersRef.child("address").setValue(address.getText().toString())
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(Shopeprofile.this, "Profile updated successfully", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(Shopeprofile.this, "Failed to update profile: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
